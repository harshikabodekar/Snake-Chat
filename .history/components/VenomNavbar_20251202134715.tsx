          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="flex flex-col">
                <h1 className={`text-lg font-bold font-mono ${getTextColor()} transition-colors duration-300`}>
                  VENOM CHAT
                </h1>
            ...
            <div className="hidden md:flex items-center space-x-2">
              <span className="text-sm opacity-70">Your Snake:</span>
              <motion.button
                onClick={() => setIsNameModalOpen(true)}
                className={`px-3 py-1 rounded-lg border transition-all duration-300 hover:scale-105 ${
            ...
            <div className="hidden lg:flex items-center space-x-1">
              {navItems.slice(1, -1).map((item, index) => (
                <motion.button
                  ...
                  className={`px-3 py-2 rounded-lg text-sm font-mono transition-all duration-300 hover:bg-current/10 ${getTextColor()}`}
